//20191205 PT8_32p 상속 시 접근지정 : protected
#include<iostream>
using namespace std;
...
class Derived : protected Base {
	//외부에서 Base의 모든 멤버를 protected로 간주 - (private 제외)
...
int main() {
	...
	x.showA();	//main함수에서 A클래스의 protected인 showA() 접근 X	-> public이 상속 접근 지정을 통해 protected가 됨 -> 상속 시 : public base로 바꾸면 됨
